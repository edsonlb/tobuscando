...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Person.cellphone'
        db.alter_column(u'core_person', 'cellphone', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Person.cellphone'
        db.alter_column(u'core_person', 'cellphone', self.gf('django.db.models.fields.CharField')(default=0, max_length=50))
