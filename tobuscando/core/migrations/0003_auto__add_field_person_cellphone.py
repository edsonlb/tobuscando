...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Person.cellphone'
        db.add_column(u'core_person', 'cellphone',
                      self.gf('django.db.models.fields.CharField')(default=0, max_length=50),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Person.cellphone'
        db.delete_column(u'core_person', 'cellphone')
    ...
    models = {
        ...
        u'core.person': {
            ...
            'cellphone': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
