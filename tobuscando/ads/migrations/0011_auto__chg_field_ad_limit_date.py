...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Ad.limit_date'
        db.alter_column(u'ads_ad', 'limit_date', self.gf('django.db.models.fields.DateField')(null=True))

    def backwards(self, orm):

        # Changing field 'Ad.limit_date'
        db.alter_column(u'ads_ad', 'limit_date', self.gf('django.db.models.fields.DateTimeField')(null=True))
    ...
    models = {
        u'ads.ad': {
            ...
            'limit_date': ('django.db.models.fields.DateField', [], {'null': 'True', 'blank': 'True'}),
        ...
        u'core.person': {
            ...
            'cellphone': ('django.db.models.fields.CharField', [], {'max_length': '50', 'null': 'True', 'blank': 'True'}),
