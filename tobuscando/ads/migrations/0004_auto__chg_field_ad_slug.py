...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Ad.slug'
        db.alter_column(u'ads_ad', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=50, null=True))

    def backwards(self, orm):

        # Changing field 'Ad.slug'
        db.alter_column(u'ads_ad', 'slug', self.gf('django.db.models.fields.SlugField')(default='', max_length=50))
