...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Offer.parent'
        db.alter_column(u'ads_offer', 'parent_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ads.Offer'], null=True))

    def backwards(self, orm):

        # Changing field 'Offer.parent'
        db.alter_column(u'ads_offer', 'parent_id', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['ads.Offer']))
