...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'ads_offer', (
            ...
            ('parent', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ads.Offer'])),
        ...
        db.send_create_signal(u'ads', ['Offer'])


    def backwards(self, orm):
        # Deleting model 'Offer'
        db.delete_table(u'ads_offer')
    ...
    models = {
        ...
        u'ads.offer': {
            ...
            'parent': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['ads.Offer']"}),
