...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'ads_ad', 'image', self.gf('cloudinary.models.CloudinaryField')(max_length=100, null=True))

    def backwards(self, orm):

        # Changing field 'Ad.image'
        db.alter_column(u'ads_ad', 'image', self.gf('cloudinary.models.CloudinaryField')(default=0, max_length=100))
